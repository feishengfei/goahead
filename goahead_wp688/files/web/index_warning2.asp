...
function initTranslation()
{
	...
	if ((lang!="en") && (lang!="de") && (lang!="fr") && (lang!="es") && (lang!="zhtw") && (lang!="it") && (lang!="turk"))
		lang = "en";
...
<form method="post" name="web_login" action="/goform/turnToIndex">
<div id="wrapper">
...
<div class="home_note">
  <ul><li class="modelname"><% getCfgGeneral(1, "SystemName"); %></li><li class="welcome_text" id="mantitle">Welcome to the device configuration interface. 
Enter the password and click 'Login'.</li>
  <li class="welcome_text"><font color="#FF0000"><% getSelectedip(); %></font></li>
	<li>
