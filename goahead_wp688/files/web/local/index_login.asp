...
<div class="home_note">
  <ul><li class="modelname"><% getCfgGeneral(1, "SystemName"); %></li>
...
<tr>
  <td>&nbsp;</td>
  <td colspan="3"><div><ul>
    <li class="button3"><input type="hidden" name="set_flag" size="1" value="0"><a href="advance/dashboard.asp" title="GO"><span id="manGO"></span></a></li>
    </ul>
  </div></td>
  </tr>
<tr>
